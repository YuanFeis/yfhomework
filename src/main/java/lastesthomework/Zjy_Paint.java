...
public class Zjy_Paint {
	...
	private void initialize() {
		...
		disxy.setFont(new Font("��������", Font.BOLD, 28));
		...
		mngraphtxt.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				disxy.setText("��ղŵ���˲鿴���ݲ˵������Ϊ����ʾ��������ļ�graph.txt�µ��ļ�");
				int yiwei=20;
		...
		mnNewMenu_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//	java.awt.Desktop.getDesktop().open(file.getParentFile());
					...
					e1.printStackTrace();
				JOptionPane.showMessageDialog(null, "δ�ҵ�����ļ�������ʱ�㻹û���������壬û����������굼�µġ�", "������ʾ",JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		panel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				y = e.getY();
				count++;
				disxy.setText("������� "+count+" �ε����壬���������Ϊ�� x = "+x+" y= "+y+" ��");
				if("Բ��".equals(tuxing)) {
					list.add("The " + count + " data written is x= " + x + "  y= " + y + " Draw a circle. \n");
					System.out.println("��" + count + "�ε�����Ϊ" + x + "," + y + "����һ��Բ");
					Graphics g = panel.getGraphics();
					g.setColor(c);
				...
				if("����".equals(tuxing)) {
					...
					System.out.println("��" + count + "�ε�����Ϊ" + x + "," + y + "����һ������");
					Graphics g = panel.getGraphics();
					g.setColor(c);
					g.clearRect(0, 0, 10000, 10000);
	...
	public void YfWrite(List<String> list) {
		...
		try {
			...
			// TODO Auto-generated catch block
			e1.printStackTrace();
		JOptionPane.showMessageDialog(null, "�޷�д�뵽����ļ��������������ػ�����", "������ʾ",JOptionPane.ERROR_MESSAGE);
		}
	}
